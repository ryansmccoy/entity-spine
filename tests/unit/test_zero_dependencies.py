...
class TestZeroDependencies:
    ...
    def test_import_entityspine_no_pydantic(self):
        ...
        pydantic_loaded = any('pydantic' in k for k in sys.modules.keys() 
...
class TestDomainModelCreation:
    ...
    def test_create_entity(self):
        ...
        from entityspine import Entity, EntityType, EntityStatus
    ...
    def test_create_resolution_result(self):
        ...
        from entityspine import (
            ResolutionResult, ResolutionStatus, ResolutionTier
        )
...
class TestFactoryFunctions:
    ...
    def test_found_result_factory(self):
        ...
        from entityspine import found_result, Entity, ResolutionTier
    ...
    def test_not_found_result_factory(self):
        ...
        from entityspine import not_found_result, ResolutionTier
