...
class TestEntityTypeExpansion:
    ...
    def test_new_entity_types_exist(self):
        ...
        expected_types = [
            "organization", "person", "government", "fund", "trust",
            "partnership", "spv", "exchange", "geo", "unknown"
        ]
...
class TestNodeRef:
    ...
    def test_create_entity_ref(self):
        ...
        from entityspine.domain import NodeRef, NodeKind
...
class TestRelationship:
    ...
    def test_create_relationship(self):
        ...
        from entityspine.domain import Relationship, NodeRef, RelationshipType
...
class TestAssetModel:
    ...
    def test_asset_types_exist(self):
        ...
        expected = ["facility", "data_center", "vessel", "aircraft", "plant", 
                    "property", "equipment", "vehicle", "inventory", "ip", "other"]
...
class TestContractModel:
    ...
    def test_contract_types_exist(self):
        ...
        expected = ["credit_facility", "lease", "material_agreement", "supply",
                    "license", "employment", "merger", "joint_venture", 
                    "service", "distribution", "settlement", "other"]
...
class TestProductModel:
    ...
    def test_product_types_exist(self):
        ...
        expected = ["drug", "device", "software", "service", "consumer_good",
                    "industrial", "financial", "food_beverage", "vehicle", "other"]
...
class TestEventModel:
    ...
    def test_event_types_exist(self):
        ...
        expected = ["m&a", "divestiture", "restructuring", "bankruptcy",
                    "legal", "regulatory", "investigation", "enforcement",
                    "cyber", "data_breach", "operational",
                    "financial", "capital", "dividend",
                    "mgmt", "board",
