...
class TestSqliteStoreKGAssets:
    ...
    def test_get_assets_by_owner(self, tmp_path: Path):
        ...
        try:
            owner_id = "entity456"
            asset1 = Asset(name="Facility A", asset_type=AssetType.FACILITY, owner_entity_id=owner_id)
            asset2 = Asset(name="Data Center B", asset_type=AssetType.DATA_CENTER, owner_entity_id=owner_id)
...
class TestSqliteStoreKGProducts:
    ...
    def test_get_products_by_owner(self, tmp_path: Path):
        ...
        try:
            owner_id = "pharma_co"
            product1 = Product(name="Drug A", product_type=ProductType.DRUG, owner_entity_id=owner_id)
            product2 = Product(name="Drug B", product_type=ProductType.DRUG, owner_entity_id=owner_id)
