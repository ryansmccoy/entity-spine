...
class TestEntityConversion:
    ...
    def test_entity_to_domain(self):
        ...
        from entityspine.adapters.pydantic import Entity as PydanticEntity, EntityType, EntityStatus
    ...
    def test_entity_from_domain(self):
        ...
        from entityspine.domain import Entity as DomainEntity, EntityType, EntityStatus
...
class TestSecurityConversion:
    ...
    def test_security_to_domain(self):
        ...
        from entityspine.adapters.pydantic import Security as PydanticSecurity, SecurityType
    ...
    def test_security_from_domain(self):
        ...
        from entityspine.domain import Security as DomainSecurity, SecurityType
...
class TestIdentifierClaimConversion:
    ...
    def test_claim_to_domain(self):
        ...
        from entityspine.adapters.pydantic import IdentifierClaim as PydanticClaim, IdentifierScheme, VendorNamespace
    ...
    def test_claim_from_domain(self):
        ...
        from entityspine.domain import IdentifierClaim as DomainClaim, IdentifierScheme, VendorNamespace
...
class TestResolutionCandidateConversion:
    ...
    def test_candidate_to_domain(self):
        ...
        from entityspine.adapters.pydantic import ResolutionCandidate as PydanticCandidate, MatchReason
    ...
    def test_candidate_from_domain(self):
        ...
        from entityspine.domain import ResolutionCandidate as DomainCandidate, MatchReason
...
'''
        ...
        assert hasattr(EntityStoreProtocol, '__protocol_attrs__') or isinstance(EntityStoreProtocol, type)
