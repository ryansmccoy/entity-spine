...
from entityspine.adapters.orm.tables import EntityTable, SecurityTable, ListingTable, ClaimTable
...
from entityspine.core.timestamps import utc_now, to_iso8601
...
class SqlModelStore:
    ...
    def get_entity_with_redirect(self, entity_id: str, max_depth: int = 10) -> Optional[Entity]:
                ...
                try:
                    ...
                    if ticker:
                        self._create_security_and_listing(
                            session, entity.entity_id, name, ticker
                        )
