...
class ResolutionCandidate(EntitySpineModel):
    ...
    # What matched
    matched_scheme: Optional[str] = Field(
        default=None,
    ...
    def to_domain(self) -> "entityspine.domain.ResolutionCandidate":
        ...
        match_reason_val = self.match_reason.value if hasattr(self.match_reason, 'value') else self.match_reason
    ...
    @classmethod
    def from_domain(cls, candidate: "entityspine.domain.ResolutionCandidate") -> "ResolutionCandidate":
        """
