...
class SubsidiaryParse:
    ...
    parent_name: Optional[str] = None  # For nested hierarchies
...
def parse_ownership(text: str) -> Tuple[Optional[float], OwnershipType, ParseConfidence]:
...
def detect_inactive_status(text: str) -> Tuple[bool, Optional[str]]:
